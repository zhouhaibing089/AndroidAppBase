 ...
 * @author Jeff Gilfelt
 */
public class ExtBadgeView extends TextView {
    ...
    public ExtBadgeView(Context context, AttributeSet attrs) {
     ...
     */
    public ExtBadgeView(Context context, View target) {
     ...
     */
    public ExtBadgeView(Context context, TabWidget target, int index) {
        this(context, null, android.R.attr.textViewStyle, target, index);
    }

    public ExtBadgeView(Context context, AttributeSet attrs, int defStyle) {
        this(context, attrs, defStyle, null, 0);
    }

    public ExtBadgeView(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
